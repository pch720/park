  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
       	 ...
       	 <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" style="top: -95px;">
         	 <div class="bg-white py-2 collapse-inner rounded">
           	 	<h6 class="collapse-header">●</h6>
           			<a class="collapse-item" href="">회원정보 상세</a>
